...
contract SeaweedStakingHBTC is SeaweedStaking, ISeaweedStakingERC20 {
    using SafeERC20 for IERC20;
    using SafeMath for uint;

    IERC20 public immutable HBTC;

    constructor(ERC20 _token, ERC20 _HBTC) public SeaweedStaking(_token, "Seaweed HBTC Staking POT", "slHBTC") {
        HBTC = _HBTC;
    }
    ...
    function sendProfit(uint amount) external override {
        ...
        if (_totalSupply > 0) {
            ...
            HBTC.safeTransferFrom(msg.sender, FALLBACK_RECIPIENT, amount);
        }
    }
